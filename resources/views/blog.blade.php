          ...
          @foreach ($blogs as $blog)
            <div class="blog_section">
              ...
              <div class="blog_feature_cantant">
                ...
                <div class="post_info">
                  <ul>
                    <li><i class="fa fa-user" aria-hidden="true"></i> {{ $blog->author ?? 'Admin' }}</li>
                ...
                <div class="bottom_info">
                  <div class="pull-left">
                    <a class="btn sqaure_bt" href="{{ route('blog.show', $blog->slug) }}">
                  ...
                  <div class="pull-right">
                    ...
                    <div class="social_icon">
                      <ul>
                        ...
                        <li class="pint"><a href="#"><i class="fa fa-pinterest"></i></a></li>
                      </ul>
                    </div>
                  </div>
                </div>
