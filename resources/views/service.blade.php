      ...
      <div class="col-md-12">
        <div class="full">
          <div class="main_heading text_align_left">
            <h2>Our services</h2>
            <p class="large">We offer the best services at a pocket friendly prices</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-md-4 service_blog">
            <div class="full">
                <div class="service_img">
                    <img class="img-responsive" src="{{ asset('storage/' . $service->image) }}" alt="{{ $service->title }}">
                </div>
                <div class="service_cont">
                    <h3 class="service_head">{{ $service->title }}</h3>
                    <p>{{ Str::limit($service->description, 100) }}</p>
                    <div class="bt_cont">
                        <a class="btn sqaure_bt" href="{{ route('service.show', $service->id) }}">View Service</a>
                    </div>
                </div>
            </div>
        </div>
