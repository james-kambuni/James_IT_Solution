      ...
      <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-xs-12">
        <div class="row">
          <div class="full">
            ...
            <div class="col-lg-12 appointment_form">
              <div class="form_section">
                @if(session('success'))
                  <div class="alert alert-success">{{ session('success') }}</div>
                @endif

                <form class="form_contant" method="POST" action="{{ route('appointments.store') }}">
                  @csrf
                  <fieldset class="row">
                    <div class="field col-lg-6">
                      <input name="first_name" class="field_custom" placeholder="First Name*" type="text" required>
                    </div>
                    <div class="field col-lg-6">
                      <input name="last_name" class="field_custom" placeholder="Last Name" type="text" required>
                    </div>
                    <div class="field col-lg-6">
                      <input name="email" class="field_custom" placeholder="Your Email" type="email" required>
                    </div>
                    <div class="field col-lg-6">
                      <input name="phone" class="field_custom" placeholder="Your Phone Number" type="text" required>
                    </div>
                    <div class="field col-lg-12">
                      <input name="subject" class="field_custom" placeholder="Subject" type="text" required>
                    </div>
                    <div class="field col-lg-12">
                      <textarea name="message" class="field_custom" placeholder="Description" required></textarea>
                    </div>
                    <div class="center">
